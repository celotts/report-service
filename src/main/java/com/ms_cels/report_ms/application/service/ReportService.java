...
public class ReportService implements ReportUseCase {
    ...
    @Override
    public String saveReport(String idReport) {
    ...
    public PatientReport generatePatientReport(String id) {
        ...
        if (fullReport.containsKey("error")) {
            throw new RuntimeException("No patient with ID was found: " + id);
        }

        return PatientReport.builder()
                .reportId((String) fullReport.get("reportId"))
                .issueDate((String) fullReport.get("issueDate"))
                .generatedReport((String) fullReport.get("generatedReport"))
                .patientId((String) fullReport.get("id"))
                .patientName(fullReport.get("name") + " " + fullReport.get("lastName"))
